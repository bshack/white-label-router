...
For `white-label-router`, treat URL/path/query values and mediator payloads as untrusted application input. Consumers remain responsible for validating data before using it in application logic or output.